...
public class Vector3i {
	...
	public Vector2i getXY() { return new Vector2i(getX(), getY()); }
	public Vector2i getXZ() { return new Vector2i(getX(), getZ()); }
	public Vector2i getYZ() { return new Vector2i(getY(), getZ()); }
	
	public Vector2i getYX() { return new Vector2i(getY(), getX()); }
	public Vector2i getZX() { return new Vector2i(getZ(), getX()); }
	public Vector2i getZY() { return new Vector2i(getZ(), getY()); }
	
	public Vector3i getXYZ() {return new Vector3i(getX(), getY(), getZ()); }
	public Vector3i getYXZ() {return new Vector3i(getY(), getX(), getZ()); }
	public Vector3i getYZX() {return new Vector3i(getY(), getZ(), getX()); }
	public Vector3i getZYX() {return new Vector3i(getZ(), getY(), getX()); }
	public Vector3i getZXY() {return new Vector3i(getZ(), getX(), getY()); }
	public Vector3i getXZY() {return new Vector3i(getX(), getZ(), getY()); }
